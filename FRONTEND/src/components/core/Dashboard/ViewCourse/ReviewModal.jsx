        ...
        >
          ...
          <div className="self-start  flex flex-col  px-5 py-2 gap-3 w-full bg-richblack-800">
            ...
            <textarea
              name="review"
              id="review"
              className="w-11/12 h-[100px] bg-richblack-700 self-center outline-none text-richblack-5 px-2"
              {...register("review", { required: true })}
            />
            {errors.review && (
              <span className="text-xs text-yellow-50">Review is required</span>
            )}
          </div>
